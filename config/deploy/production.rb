set :stage, :staging
set :deploy_to, -> { "/home/u42-fhxqv0zojoxu/www/azariascapital.com" }
set :tmp_dir, "/home/u42-fhxqv0zojoxu/www/azariascapital.com/tmp"
set :keep_releases, 2
...
# ======================
server 'c61022.sgvps.net', user: 'u42-fhxqv0zojoxu', port: 18765, password: 'ssh.St34lth!', roles: %w{web app db}
...
SSHKit.config.command_map[:composer] = "/usr/bin/php /home/u42-fhxqv0zojoxu/composer.phar"
